...
<p align="left">
Essa aplicação é um exemplo simples de interatividade, onde você pode conhecer pokémons de diversos tipos de forma aleatória
</p>
...
``` bash
# Clone o repositório
$ git clone <https://github.com/Leandro2585/pokedex>
...
- [x] Selecionar um pokémon aleatório;<br>
- [x] Trazer informações do pokémon como nome, imagem e tipo<br>
- [x] Narrar outras informações sobre o pokémon;<br>
